// Jack loves Sundays as he gets to play and cycle with his friends. Given that a month can start on any day of the week, determine how many Sundays Jack will have in N days
// Example: Input: Monday (start day of month), N=13       Output : 2
